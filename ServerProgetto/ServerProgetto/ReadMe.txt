========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto ServerProgetto
========================================================================

La creazione guidata applicazione ha creato questa applicazione ServerProgetto.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione ServerProgetto.


ServerProgetto.vcxproj
...
ServerProgetto.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato ServerProgetto.pch e il file dei tipi precompilato StdAfx.obj.
